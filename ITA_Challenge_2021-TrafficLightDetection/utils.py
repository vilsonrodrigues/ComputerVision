...
for path in ['dev','train']:
	for pathAndFilename in glob.iglob(os.path.join(current_dir+'/'+path, "*.jpg")):
	    title, ext = os.path.splitext(os.path.basename(pathAndFilename))
	    if path == 'dev':
	        file_dev.write("data-detection" + "/" + path +'/' + title + '.jpg' + "\n")
	    elif path == 'train':
	        file_train.write("data-detection" + "/" + path +'/' + title + '.jpg' + "\n")	      